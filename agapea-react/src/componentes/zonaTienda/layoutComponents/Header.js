...
import { useClienteLoggedContext } from '../../../App'; //<--- importo hook-personalizado para acceder al global-state 
                                ...
                                <form >
                                    <div className="bg-gray border border-5 border w-75 h-100 d-flex flex-row">
                                        ...
                                        <div className="bg-primary p-2 border border-5 border-end-0 border-top-0 border-bottom-0">
                                            <a id="botonBuscar" onClick={()=> document.forms[0].submit() } ><img src="/images/lupa.png" width="auto" height="20" /></a>
                                        </div>
                                    </div>
